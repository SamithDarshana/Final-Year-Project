...
# # You may need to download this manually
# mouth_cascade = cv2.CascadeClassifier(
#     cv2.data.haarcascades + 'haarcascade_mcs_mouth.xml')

# # Function to preprocess image for eye model


# def preprocess_eye(img):
#     eye = cv2.resize(img, (48, 48))
#     eye = eye / 255.0
#     eye = eye.reshape(1, 48, 48, 1)
#     return eye
...
#         for (ex, ey, ew, eh) in eyes[:1]:  # Use one eye for prediction
...
#             cv2.putText(frame, f"Eye: {label}", (x, y - 10),
...
#         # (Optional) Add yawning detection here using mouth_cascade and another model
